...
class Artist:
    ...
    def draw_frame(
        ...
        # draw dat map
        # self.draw_map(
        #     screen=screen, map=simulation.sim_maps[AltitudeMap], show_zero=False
        # )
        self.draw_map(
            screen=screen,
        ...
        self.draw_items(
            screen=screen,
            items=simulation.sim_items,
            colour=(200, 50, 0),
            radius=sconf.item_collect_dist,
        )
        self.draw_items(
            screen=screen,
            items=[simulation.sim_drain],
            colour=(100, 50, 150),
            radius=sconf.item_collect_dist * sconf.drain_item_scale_mod,
        )
